<svg width="1.5rem" height="1.5rem" viewBox="0 0 24 24" fill="currentColor" class="text-dark dark:text-gray-100"
...
</svg><?php /**PATH /www/wwwroot/syswaw/resources/views/components/icon/transactions.blade.php ENDPATH**/ ?>