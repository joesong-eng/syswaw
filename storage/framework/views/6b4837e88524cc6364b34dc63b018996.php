        ...
        <?php if(Route::has('login')): ?>
            <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                <?php if(auth()->guard()->check()): ?>
                    <?php if(Auth::user()->hasRole('admin') || Auth::user()->hasRole('admin_manager')): ?>
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"><?php echo e('msg.dashboard'); ?></a>
                    <?php else: ?>
                    <a href="<?php echo e(route('dashboard')); ?>" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"><?php echo e('msg.dashboard'); ?></a>
                    <?php endif; ?>
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"><?php echo e(__('msg.login')); ?></a>
                    <?php if(Route::has('register')): ?>
                        <a href="<?php echo e(route('register')); ?>" class="ml-4 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"><?php echo e(__('msg.register')); ?></a>
                    <?php endif; ?>
                <?php endif; ?>
            </div>
        <?php endif; ?>
                    ...
                    <a class="scale-100 p-3 bg-gray dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-500 dark:text-gray-400 ">
                                <?php echo e(__('msg.homepage.tagline')); ?></h2>
                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                <?php echo e(__('msg.homepage.description.line1')); ?>

                                <?php echo e(__('msg.homepage.description.line2')); ?>

                                <?php echo e(__('msg.homepage.description.line3')); ?>
...
<?php endif; ?>
<?php /**PATH /www/wwwroot/syswaw/resources/views/welcome.blade.php ENDPATH**/ ?>