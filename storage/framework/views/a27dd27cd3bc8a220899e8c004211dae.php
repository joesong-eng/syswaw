...
<head>
    ...
    <?php echo csrf_field(); ?>
    <title><?php echo e(config('app.name', 'SYS')); ?></title>
...
<style>
    ...
    .bg-logo1 {
        background-image: url('<?php echo e(asset('storage/images/iotlink_01.png')); ?>');
    }

    .bg-logo2 {
        background-image: url('<?php echo e(asset('storage/images/iotlink_02.png')); ?>');
    }
...
<body class="dark:bg-gray-900">
    <div class="flex ">
        <?php if(auth()->guard()->check()): ?>
            <?php echo $__env->make('navigation-menu', ['title' => $title ?? ''], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php if(Auth::check() && Auth::user()->roles()->count() > 0): ?>
                <?php if (isset($component)) { $__componentOriginala94d64a237f48cfe33e0039354c0891a = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala94d64a237f48cfe33e0039354c0891a = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal.sidebar','data' => ['class' => 'relative pt-14 flex-shrink-0']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('modal.sidebar'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'relative pt-14 flex-shrink-0']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala94d64a237f48cfe33e0039354c0891a)): ?>
<?php $attributes = $__attributesOriginala94d64a237f48cfe33e0039354c0891a; ?>
<?php unset($__attributesOriginala94d64a237f48cfe33e0039354c0891a); ?>
<?php endif; ?>
<?php if (isset($__componentOriginala94d64a237f48cfe33e0039354c0891a)): ?>
<?php $component = $__componentOriginala94d64a237f48cfe33e0039354c0891a; ?>
<?php unset($__componentOriginala94d64a237f48cfe33e0039354c0891a); ?>
<?php endif; ?>
            <?php endif; ?>
                    ...
                    <div class="bg-gray-100 dark:bg-gray-900  h-[calc(100vh-110px)] sm:h-[calc(100vh-48px)]">
                        ...
                        <div id="alert-warning" class="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-4 relative" role="alert">
                            <span class="block sm:inline">
                                <strong class="font-bold"><?php echo e(__('msg.contact.title')); ?></strong>
                                <?php echo e(__('msg.emailVerified')); ?>

                                <a href="<?php echo e(route('verification.notice')); ?>" class="underline text-yellow-800 hover:text-yellow-600"><?php echo e(__('msg.clickToVerify')); ?></a>
                            </span>
                        ...
                        <?php if(session('error')): ?>
                            <div id="error-message" class="absolute message ms-4 p-2 text-red-600 bg-red-100 z-10 border border-red-200 rounded-lg  duration-1000 ease-out transform transition-transform slide-in">
                                <ul><li><?php echo e(session('error')); ?></li></ul>
                            </div>
                        <?php endif; ?>
                        <?php if($errors->any()): ?>
                        ...
                        <main>
                            <?php if(!Auth::user()->arcade && Auth::user()->hasRole('arcade-owner')): ?>
                            <div class="relative bg-gray-100 m-auto">
                                ...
                                <a class="m-auto"href="<?php echo e(route('arcade.create')); ?>"> <?php echo e(__('msg.bind_arcade')); ?></a>
                            </p>
                            </div>
                            <?php endif; ?>
...
<script>
        ...
        document.querySelectorAll('form').forEach(form => {
            form.addEventListener('submit', async (event) => {
                ...
                const confirmationMessage = form.getAttribute('data-confirm') || 
                                        (isConfirmSubmit ? '<?php echo e(__("msg.add_token")); ?>' : null);
                ...
                if (confirmationMessage) {
                    ...
                    try {
                        const result = await Swal.fire({
                            title: '<?php echo e(__("msg.confirm")); ?>',
                            text: confirmationMessage,
                            icon: 'question',
                            showCancelButton: true,
                            confirmButtonText: '<?php echo e(__("msg.yes")); ?>',
                            cancelButtonText: '<?php echo e(__("msg.cancel")); ?>'
                        });
    ...
    function showLocalMessage() {// 如果消息容器不存在，则动态创建并插入到 <header> 底下
        ...
        // 设置消息内容和样式
        successMessage.textContent = '<?php echo e(__("msg.err_del_arcadeKey")); ?>'; // 使用 Laravel 翻译函数
    ...
    function copyToClipboardAndGenerateLink(Key, abstype) { //晶片或店面
        ...
        var stype = (abstype === 'chip') ? "<?php echo e(__('msg.chip')); ?>" : "<?php echo e(__('msg.arcade')); ?>";
        if (Key.charAt(0) === 'm') {
            // 如果是機器金鑰，直接複製到剪貼簿
            textArea.value = Key;
    ...
    function handlePrintClick() {
        ...
        form.method = 'POST';
        form.action = '<?php echo e(route('printKeys')); ?>';
...
</html><?php /**PATH /www/wwwroot/syswaw/resources/views/layouts/app.blade.php ENDPATH**/ ?>