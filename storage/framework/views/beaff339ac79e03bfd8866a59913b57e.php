...
<div class="relative" x-data="{ open: false }" @click.away="open = false" @close.stop="open = false">
    ...
    <div x-show="open"
        ...
        <div class="rounded-md ring-1 ring-black ring-opacity-5
            ...
            dark:text-gray-200 dark:bg-gray-600  dark:hover:bg-gray-500 
            <?php echo e($contentClasses); ?>">
            <?php echo e($content); ?>

        </div>
    </div>
</div>
<?php /**PATH /www/wwwroot/syswaw/resources/views/components/dropdown.blade.php ENDPATH**/ ?>