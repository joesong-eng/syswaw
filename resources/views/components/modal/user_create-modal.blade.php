<div x-cloak x-show="createUserModal" class="fixed inset-0 z-50" 
    ...
    <div class="relative w-full h-full flex items-center justify-center p-4">
        <div class="p-6 relative bg-white dark:bg-gray-800 w-full max-w-md rounded-lg shadow-lg">
            <h2 class="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-4">{{ __('msg.add') }}{{ __('msg.user') }}</h2>
            <form action="{{ route('admin.users.store') }}" method="POST" @submit="createUserModal = false">
                ...
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-800 dark:text-gray-100">{{ __('msg.password') }}</label>
                ...
                <div id="filter" class="mb-4 relative">
                    <label class="block text-sm font-medium text-gray-800 dark:text-gray-100">{{ __('msg.select_parent_user') }} 
