<label for="machine_type" class=" block text-sm text-gray-600 dark:text-gray-400">{{ __('msg.machine_type') }}</label>
<select id="machine_type" name="machine_type" class="w-full mt-1 p-2 border rounded-md focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300" x-model="selectedMachine.machine_type" required>
