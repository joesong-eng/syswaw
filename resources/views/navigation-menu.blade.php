        ...
        <div class="flex justify-between h-12 w-full" >
            <div class="my-auto flex">
                ...
                <div class="flex items-center">
                    ...
                    @if (optional(Auth::user()->store)->name) <!-- 店家名稱 -->
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="flex items-center px-4">
                ...
                <div>
                    ...
                    dark:text-gray-300">{{ Auth::user()->name }}</div>
...
<script>
    ...
    //         logo.src = "{{ asset('storage/images/iotlink_02.png') }}";
    //     } else {
    //         logo.src = "{{ asset('storage/images/iotlink_01.png') }}";
    //     }
    // }
