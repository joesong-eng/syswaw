{{-- resources/views/machine/machines/index.blade.php --}}
@extends('layouts.app')
...
@section('content')
    <div class="py-2" x-data="machineManagement()">
                ...
                @forelse ($machines ?? [] as $machine)
                    <div
                        ...
                        <div class="w-[9%] flex items-center justify-center m-auto">
                            <form action="{{ route('machine.machines.toggleActive', $machine->id) }}" method="POST"
                        ...
                        <div class="w-[15%] flex items-center justify-center space-x-1 m-auto">
                            <div class="flex justify-items-end space-x-1">
                                ...
                                <form action="{{ route('machine.machines.destroy', $machine->id) }}" method="POST"
                                    class="m-0">
                                    @csrf
                                    @method('DELETE')
                                    <x-button
        ...
        @include('machine.machines.partials.create-modal')
        @include('machine.machines.partials.edit-modal')

    </div>
@endsection

@push('scripts')
    @include('machine.machines.partials.script')
@endpush
