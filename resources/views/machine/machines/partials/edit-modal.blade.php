...
<div x-cloak x-show="showEditMachineModal" class="fixed inset-0 z-50 overflow-y-auto pb-5"
    ...
    <div class="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div
            ...
            <form :action="`/machine/machines/${editForm.id}`" method="POST" id="editMachineForm"
                    ...
                    <div class="mt-4 space-y-4">
                        ...
                        <div class="flex flex-col sm:flex-row gap-4">
                            <div class="sm:w-2/5">
                                ...
                                <input type="text" name="chip_hardware_id" id="edit_chip_hardware_id_modal_arcade"
                            ...
                            <div class="sm:w-3/5">
                                <label for="auth_key_edit_display_arcade"
                                    class="block text-sm font-medium text-gray-700">{{ __('msg.machine_auth_key_display_label') }}</label>
                                <input type="text" id="auth_key_edit_display_arcade" name="auth_key"
                                ...
                                {{-- <p class="mt-1 text-xs text-gray-500">
                                    <span x-show="editForm.auth_key">{{ __('msg.auth_key_bound_hint_short') }}</span>
                                    <span
                                        x-show="!editForm.auth_key">{{ __('msg.auth_key_not_bound_hint_short') }}</span>
                                </p> --}}
                            </div>
                        </div>
