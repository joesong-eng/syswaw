{{-- resources/views/admin/tcp/modal/schedule.blade.php --}}
{{-- **** 新增：定時擷取控制 *********************************************** --}}
<div x-cloak x-data="{ showTcpControl: false }" class="space-x-2 m-auto max-w-xl">
    <div class="mt-4 p-4 bg-indigo-50 rounded-lg shadow">
        ...
        <div class="flex flex-wrap items-center gap-4">
            <div>
                <label for="schedule_interval" class="text-sm text-gray-700 mr-2">擷取週期:</label>
        ...
        <div class="mt-2 text-sm">
            ...
            <span id="schedule_status_display" class="ml-1 font-medium text-blue-600">讀取中...</span>
        </div>
    </div>
