            ...
            Alpine.data('reportPage', () => ({
                ...
                get pageSummary() {
                    ...
                    this.displayedData.forEach(item => {
                        ...
                        summary.assign_credit_value += Number(item.assign_credit_value) ||
                        0;
                ...
                get filteredMachines() {
                    ...
                    if (this.filters.arcade_id) filtered = filtered.filter(m => m.arcade_id == this
                        .filters.arcade_id);
                    if (this.filters.machine_type) filtered = filtered.filter(m => m.machine_type ==
                        this.filters
                        .machine_type);
                    if (this.filters.owner_id) filtered = filtered.filter(m => m.owner_id == this
                        .filters.owner_id);
                    return filtered;
                },
                get displayedData() {
