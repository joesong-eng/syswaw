...
<div x-cloak x-show="showEditMachineModal" class="fixed inset-0 z-50 overflow-y-auto pb-5"
    ...
    <div class="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div
            ...
            <form :action="'{{ route('admin.machines.update', '__ID__') }}'.replace('__ID__', editForm.id)"
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div class="mt-4 space-y-4">
                        ...
                        <div class="flex flex-row sm:flex-row gap-4">
                            <div class="w-[40%]">
                                <label for="edit_chip_hardware_id_modal_arcade" class="block text-sm font-medium text-gray-700">
                                    {{ __('msg.chip_hardware_id') }}
                                </label>
                                <input type="text" id="edit_chip_hardware_id_modal_arcade" x-model="editForm.chip_hardware_id"
                            ...
                            <div class="w-[60%]">
                                <label for="auth_key_edit_display_arcade" class="block text-sm font-medium text-gray-700">
                        ...
                        <div class="border border-gray-200 p-4 rounded-md space-y-4 ">
                            ...
                            <div class="MTP flex flex-col sm:flex-row gap-4">
                                <div class="flex-1 機器類型">
                                    <x-machine-attr name="machine_type" label="msg.machine_type" type="select"
                                        required="true" model="editForm.machine_type" :options="config('machines.types', [])" />
                                </div>
                                <div x-show="!editForm.machine_type || editForm.machine_type !== 'money_slot'"
                                    ...
                                    <x-machine-attr name="payout_type" label="msg.payout_type" type="select"
                                        required="true" model="editForm.payout_type" :options="[
                                            'none' => 'msg.select',
                            ...
                            <input type="hidden" name="accepted_denominations" value="" x-show="editForm.machine_type !== 'money_slot'">

                            <div x-show="editForm.machine_type === 'money_slot'" class="border border-blue-300 p-4 rounded-md space-y-4 mt-4">
                                <!-- 現有 money_slot 設定 -->
