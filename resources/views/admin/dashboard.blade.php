    ...
    <div class="py-1">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="relative bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6">
                <!-- User Stats -->
                <div class="bg-white dark:bg-gray-700 overflow-hidden shadow rounded-lg p-2">
                ...
                <div class="flex gap-1">
                    ...
                    <div class="bg-white dark:bg-gray-700 rounded-lg shadow p-3">
                        <div class="text-center">
                            ...
                            <p class="text-2xl font-semibold text-gray-800 dark:text-white">{{ \App\Models\User::count() }}
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="bg-white dark:bg-gray-700 rounded-lg shadow p-3">
                        <div class="text-center">
                            ...
                            <p class="text-2xl text-center font-semibold text-gray-800 dark:text-white">
                    ...
                    <div class="bg-white dark:bg-gray-700 rounded-lg shadow p-3">
                        <div class="text-center">
                            ...
                            <p class="text-2xl font-semibold text-gray-800 dark:text-white">{{ \App\Models\Role::count() }}
                            </p>
                        </div>
                    </div>
                </div>
