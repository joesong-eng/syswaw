        ...
        foreach ($machines as $machineData) {
            ...
            $machine = Machine::updateOrCreate(
                ...
                [
                    ...
                    'machine_category' => $machineData['machine_category'] ?? null, // 新增 machine_category
                    'share_pct' => 0.20,
