...
class ChipController extends Controller{ // 顯示 Chip Key 列表頁面
    ...
    private function clear_expire_key(){ // 刪除未使用且過期的金鑰
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('chips.index')->with('success', 'Chip Key 刪除成功');
    }
